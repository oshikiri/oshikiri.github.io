...
1. D3が出力するSVGを意識する必要がある（通常のチャートライブラリでは出力した画像やHTMLの中身を意識することはない）
2. 使うために必要になる事前知識（JavaScript、HTML、SVG、…）が多い
...
[実際のD3の構成](https://github.com/d3/d3/blob/v7.8.5/src/index.js)を見ると、おおまかな機能ごとにリポジトリが別れていて、 d3/d3リポジトリですべてを読み込む形になっている。
